        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          ...
          >
            <div className="absolute inset-0 z-0 overflow-hidden">
              <img
                src={new URL('../assets/images/WeddingTitle_compressed.webp', import.meta.url).href}
                alt="Photography"
          ...
          >
            <div className="absolute inset-0 z-0 overflow-hidden">
              <img
                src={new URL('../assets/images/VideoTitle_compressed.webp', import.meta.url).href}
          ...
          >
            <div className="absolute inset-0 z-0 overflow-hidden">
              <img
                src={new URL('../assets/images/BoothTitle_compressed.webp', import.meta.url).href}
